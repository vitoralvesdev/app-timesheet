...
export const OsDetails = () => {
  ...
  return (
    <Box flex={1} {...safeAreaProps}>
      ...
      <VStack mb={spacing.xs} alignItems="center" justifyContent="center">
        <Text color="gray.500" fontSize={spacing.md} fontWeight="bold">
          BHUT
        </Text>
        <Text color="gray.100" fontSize={spacing.md}>
          OS: 12345678
        </Text>
      </VStack>
