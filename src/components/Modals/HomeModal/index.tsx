                ...
                <LinearGradient colors={THEME.colors.linearGradientBg} style={$flex}>
                    <View style={$containerStyle}>
                        <View style={$flex}>
                            ...
                            >
                                <ButtonClose onPress={closeCallback} color={THEME.colors.primary[200]}/>
                            </Box>
                            ...
                            >
                                <View style={$page} key="1">
                                    <Box paddingX={spacing.xxs}>
                                        ...
                                        >Seu controle de horas de forma efetiva</Text>

                                        <Text
                                            mt={spacing.xxs}
                                            color="gray.400"
                                        >Faça o apontamento de horas das suas ordens de serviço de forma efetiva</Text>
                                    </Box>
                                </View>
                                ...
                                <View style={$page} key="2">
                                    <Box paddingX={spacing.xxs}>
                                        <Text
                                            ...
                                            bold
                                            lineHeight={spacing.xl}
                                        >Tudo na palma da mão</Text>

                                        <Text
                                            mt={spacing.xxs}
                                            color="gray.400"
                                        >Através do seu celular, faça o apontamento das horas sem perder tempo</Text>
                                    </Box>
                                </View>
                                ...
                                <View style={$page} key="3">
                                    <Box paddingX={spacing.xxs}>
                                        <Text
                                            ...
                                            bold
                                            lineHeight={spacing.xl}
                                        >Otimize seu tempo</Text>

                                        <Text
                                            mt={spacing.xxs}
                                            color="gray.400"
                                        >Antes mesmo de sair do cliente, feche sua ordem de serviço e aponta suas horas gastas</Text>
                                    </Box>
                                </View>
                            </PagerView>
                        </View>
